...
public static Type init_plugin() {
	return typeof(Ambition.PluginSupport.JSONSchemaPlugin);
}
...
namespace Ambition.PluginSupport {
	 ...
	 */
	public class JSONSchemaPlugin : Object,IPlugin {
		public string name { get { return "JSONSchema"; } }
